import{w as e}from"./mmdStage-CRyRuQDK.js";import{s as fe,m as ne,d as se,a as le,l as de}from"./logDepthDeclaration-D5eG2_JY.js";import{h as ce}from"./helperFunctions-DmpQKAc1.js";import"./index-BUDfz2qs.js";const t="objectIdFunctions",R=`fn encodeObjectId(objectId: f32)->vec4f {
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=R);const ve={name:t,shader:R},a="prePassDeclaration",F=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=F);const ue={name:a,shader:F},i="oitDeclaration",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=y);const pe={name:i,shader:y},o="lightUboDeclaration",N=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=N);const he={name:o,shader:N},f="ltcHelperFunctions",M=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=M);const me={name:f,shader:M},n="clusteredLightingFunctions",O=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=O);const Se={name:n,shader:O},s="clusteredLightingCompute",b=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=b);const ge={name:s,shader:b},l="lightsFragmentFunctions",W=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=W);const xe={name:l,shader:W},d="shadowsFragmentFunctions",G=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=G);const Le={name:d,shader:G},c="samplerFragmentDeclaration",z=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=z);const Te={name:c,shader:z},v="fresnelFunction",U=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=U);const Ce={name:v,shader:U},u="reflectionFunction",H=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=H);const Ee={name:u,shader:H},p="imageProcessingDeclaration",V=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=V);const we={name:p,shader:V},h="imageProcessingFunctions",B=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=B);const Ie={name:h,shader:B},m="textureRepetitionFunctions",k=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=k);const De={name:m,shader:k},S="bumpFragmentMainFunctions",Y=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Y);const Ae={name:S,shader:Y},g="bumpFragmentFunctions",$=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=$);const Pe={name:g,shader:$},x="clipPlaneFragmentDeclaration",j=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=j);const Xe={name:x,shader:j},L="fogFragmentDeclaration",q=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=q);const _e={name:L,shader:q},T="clipPlaneFragment",Z=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=Z);const Re={name:T,shader:Z},C="bumpFragment",Q=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=Q);const Fe={name:C,shader:Q},E="decalFragment",J=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=J);const ye={name:E,shader:J},w="depthPrePass",K=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=K);const Ne={name:w,shader:K},I="lightFragment",ee=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=ee);const Me={name:I,shader:ee},D="logDepthFragment",re=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=re);const Oe={name:D,shader:re},A="fogFragment",te=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=te);const be={name:A,shader:te},P="meshBlendTagFragmentOutput",ae=`#if SCENE_MRT_COUNT>{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=ae);const We={name:P,shader:ae},X="oitFragment",ie=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=ie);const Ge={name:X,shader:ie},_="defaultPixelShader",oe=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[_]||(e.ShadersStoreWGSL[_]=oe);const ze=[fe,ne,se,ve,ue,pe,le,ce,he,me,Se,ge,xe,Le,Te,Ce,Ee,we,Ie,De,Ae,Pe,Xe,de,_e,Re,Fe,ye,Ne,Me,Oe,be,We,Ge];for(const r of ze)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const ke={name:_,shader:oe};export{ke as defaultPixelShaderWGSL};
