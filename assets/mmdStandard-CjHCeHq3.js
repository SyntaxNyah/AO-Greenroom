import{M as i,S as l,c as s,d as a}from"./mmdStage-B116ZMi5.js";import"./index-D2MxVOoB.js";function f(o){return o.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}class u extends i{isCompatible(n){switch(n){case l.WGSL:return!0;default:return!1}}getCustomCode(n){if(n==="vertex"){const e={};return e.CUSTOM_VERTEX_DEFINITIONS=s,e[`!${f("finalWorld=finalWorld*influence;")}`]=`
${a}
