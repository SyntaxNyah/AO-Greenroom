import{w as e}from"./mmdStage-CzLPsH-_.js";import{s as fe,m as se,d as de,a as ce,l as ve}from"./logDepthDeclaration-D2WFY4qt.js";import{h as he}from"./helperFunctions-BwZSIjBQ.js";import"./index-C5kJ3GPh.js";const t="decalFragmentDeclaration",_=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=_);const ue={name:t,shader:_},o="defaultFragmentDeclaration",N=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=N);const pe={name:o,shader:N},a="objectIdFunctions",M=`highp vec4 encodeObjectId(highp float objectId) {
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=M);const me={name:a,shader:M},r="prePassDeclaration",O=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=O);const ge={name:r,shader:O},n="oitDeclaration",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=y);const Se={name:n,shader:y},l="lightFragmentDeclaration",b=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=b);const Ee={name:l,shader:b},f="lightUboDeclaration",U=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=H);const De={name:s,shader:H},d="clusteredLightingFunctions",W=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=W);const Ce={name:d,shader:W},c="lightsFragmentFunctions",G=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=G);const Ie={name:c,shader:G},v="shadowsFragmentFunctions",z=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=z);const Le={name:v,shader:z},h="samplerFragmentDeclaration",V=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=V);const Ae={name:h,shader:V},u="fresnelFunction",B=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=B);const we={name:u,shader:B},p="reflectionFunction",k=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=k);const xe={name:p,shader:k},m="imageProcessingDeclaration",Y=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Y);const Pe={name:m,shader:Y},g="imageProcessingFunctions",$=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=$);const Re={name:g,shader:$},S="textureRepetitionFunctions",Z=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=Z);const Xe={name:S,shader:Z},E="bumpFragmentMainFunctions",j=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=j);const Fe={name:E,shader:j},T="bumpFragmentFunctions",q=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=q);const _e={name:T,shader:q},D="clipPlaneFragmentDeclaration",Q=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Q);const Ne={name:D,shader:Q},C="fogFragmentDeclaration",J=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=J);const Me={name:C,shader:J},I="clipPlaneFragment",K=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=K);const Oe={name:I,shader:K},L="bumpFragment",ee=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=ee);const ye={name:L,shader:ee},A="decalFragment",ie=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ie);const be={name:A,shader:ie},w="depthPrePass",te=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=te);const Ue={name:w,shader:te},x="lightFragment",oe=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=oe);const He={name:x,shader:oe},P="logDepthFragment",ae=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ae);const We={name:P,shader:ae},R="fogFragment",re=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=re);const Ge={name:R,shader:re},X="oitFragment",ne=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=ne);const ze={name:X,shader:ne},F="defaultPixelShader",le=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[F]||(e.ShadersStore[F]=le);const Ve=[ue,pe,fe,se,de,me,ge,Se,ce,he,Ee,Te,De,Ce,Ie,Le,Ae,we,xe,Pe,Re,Xe,Fe,_e,Ne,ve,Me,Oe,ye,be,Ue,He,We,Ge,ze];for(const i of Ve)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ze={name:F,shader:le};export{Ze as defaultPixelShader};
