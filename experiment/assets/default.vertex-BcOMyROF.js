import{w as e}from"./mmdStage-DOgKdbar.js";import{s as oe,m as se,d as ue,a as le,l as ve}from"./logDepthDeclaration-BBCzQ6Dp.js";import{h as ce}from"./helperFunctions-DLINJgtJ.js";import"./index-BaPdAJ8g.js";const i="uvAttributeDeclaration",M=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=M);const pe={name:i,shader:M},r="bonesDeclaration",y=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=y);const me={name:r,shader:y},n="bakedVertexAnimationDeclaration",W=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=W);const xe={name:n,shader:W},a="instancesDeclaration",F=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=F);const Ee={name:a,shader:F},f="prePassVertexDeclaration",C=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=C);const Ie={name:f,shader:C},d="samplerVertexDeclaration",D=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=D);const _e={name:d,shader:D},o="bumpVertexDeclaration",X=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=X);const Se={name:o,shader:X},s="clipPlaneVertexDeclaration",b=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=b);const Te={name:s,shader:b},u="fogVertexDeclaration",G=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=G);const Ne={name:u,shader:G},l="lightVxFragmentDeclaration",z=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=z);const Ve={name:l,shader:z},v="lightVxUboDeclaration",w=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=w);const Ae={name:v,shader:w},c="morphTargetsVertexGlobalDeclaration",B=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=B);const Ue={name:c,shader:B},p="morphTargetsVertexDeclaration",H=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=H);const Oe={name:p,shader:H},m="vertexPullingDeclaration",Y=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=Y);const he={name:m,shader:Y},x="vertexPullingVertex",$=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=$);const Le={name:x,shader:$},E="morphTargetsVertexGlobal",k=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=k);const Re={name:E,shader:k},I="morphTargetsVertex",j=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=j);const ge={name:I,shader:j},_="instancesVertex",K=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=K);const Pe={name:_,shader:K},S="bonesVertex",Q=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Q);const Me={name:S,shader:Q},T="bakedVertexAnimation",q=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=q);const ye={name:T,shader:q},N="prePassVertex",Z=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=Z);const We={name:N,shader:Z},V="uvVariableDeclaration",J=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=J);const Fe={name:V,shader:J},A="samplerVertexImplementation",ee=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=ee);const Ce={name:A,shader:ee},U="bumpVertex",te=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=te);const De={name:U,shader:te},O="clipPlaneVertex",ie=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=ie);const Xe={name:O,shader:ie},h="fogVertex",re=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=re);const be={name:h,shader:re},L="shadowsVertex",ne=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=ne);const Ge={name:L,shader:ne},R="vertexColorMixing",ae=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=ae);const ze={name:R,shader:ae},g="logDepthVertex",fe=`#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=fe);const we={name:g,shader:fe},P="defaultVertexShader",de=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[P]||(e.ShadersStoreWGSL[P]=de);const Be=[oe,se,ue,pe,ce,me,xe,Ee,Ie,le,_e,Se,Te,Ne,Ve,Ae,Ue,Oe,ve,he,Le,Re,ge,Pe,Me,ye,We,Fe,Ce,De,Xe,be,Ge,ze,we];for(const t of Be)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const je={name:P,shader:de};export{je as defaultVertexShaderWGSL};
